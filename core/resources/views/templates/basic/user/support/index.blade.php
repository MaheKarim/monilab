        ...
        <div class="deposit-table-section">
            <div class="custom-container">
                <div class="row justify-content-center mt-4">
                    <div class="col-md-12">
                        <div class="text-end">
                            <a href="{{route('ticket.open') }}" class="btn btn-sm cmn-btn mb-2"> <i class="fas fa-plus"></i> @lang('New Ticket')</a>
                        </div>
                            ...
                            <table class="table custom--table deposit-table">
                                ...
                                @forelse($supports as $support)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ route('ticket.view', $support->ticket) }}" class="btn cmn-btn sm-cmn-btn ">
